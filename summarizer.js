...
exports.getSentencesRanks = exports.getSortedSentences = exports.getBestSentence = exports.formatSentence = exports.sentencesIntersection = exports.splitContentToParagraphs = exports.splitContentToSentences = exports.onlyGetSentences = undefined;
...
var onlyGetSentences = exports.onlyGetSentences = function onlyGetSentences(text) {
...
var splitContentToSentences = exports.splitContentToSentences = function splitContentToSentences(content, callback) {
...
var splitContentToParagraphs = exports.splitContentToParagraphs = function splitContentToParagraphs(content, callback) {
    callback(content.split("\n\n"));
};

var sentencesIntersection = exports.sentencesIntersection = function sentencesIntersection(sent1, sent2, callback) {
    var s1 = sent1.split(' ');
    var s2 = sent2.split(' ');
...
var formatSentence = exports.formatSentence = function formatSentence(sentence, callback) {
...
var getBestSentence = exports.getBestSentence = function getBestSentence(paragraph, sentences_dict, callback) {
...
var getSortedSentences = exports.getSortedSentences = function getSortedSentences(paragraph, sentences_dict, n, callback) {
    splitContentToSentences(paragraph, function (sentences) {
        ...
        sentence_scores = sentence_scores.sort(function (a, b) {
...
var getSentencesRanks = exports.getSentencesRanks = function getSentencesRanks(content, callback, sentences_dict) {
